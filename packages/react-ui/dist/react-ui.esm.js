...
function Button(_ref) {
  ...
  var classes = clsx(styles$2.button, (_clsx = {}, _defineProperty(_clsx, styles$2.smBtn, size === 'small'), _defineProperty(_clsx, styles$2.lgBtn, size === 'large'), _defineProperty(_clsx, styles$2.xlBtn, size === 'xl'), _defineProperty(_clsx, styles$2.roundedBtn, isRounded === true), _clsx));
